...
function Parameter(loc, name, dataType) {
  Node.call(this, 'Parameter', loc);
  this.name = name;
  this.dataType = dataType;
}
...
function AddExpression(loc, operator, left, right, dataType) {
  Node.call(this, 'AddExpression', loc);
  this.operator = operator;
  this.left = left;
  this.right = right;
  this.dataType = dataType;
}
AddExpression.prototype = Object.create(Node.prototype);
