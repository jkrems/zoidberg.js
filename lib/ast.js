...
var debug = require('debug')('zoidberg:ast');
...
Node.prototype.visit = function(visitors) {
  ...
  if (typeof visitor === 'function') {
    ...
    debug('No visitor for %s', this.type);
  }
};
...
function ImportDeclaration(loc, source, extraction) {
  Node.call(this, 'ImportDeclaration', loc, []);
  this.source = source;
  this.extraction = extraction;
}
ImportDeclaration.prototype = Object.create(Node.prototype);
exports.ImportDeclaration = ImportDeclaration;


function Identifier(loc, name, dataType) {
  Node.call(this, 'Identifier', loc, []);
  this.name = name;
  this.dataType = dataType;
}
...
function CatchAllPattern(loc, dataType) {
  Node.call(this, 'CatchAllPattern', loc);
  this.dataType = dataType;
}
CatchAllPattern.prototype = Object.create(Node.prototype);
exports.CatchAllPattern = CatchAllPattern;


function BindingPattern(loc, bindings, dataType) {
  Node.call(this, 'BindingPattern', loc);
  this.bindings = bindings;
  this.dataType = dataType;
}
BindingPattern.prototype = Object.create(Node.prototype);
