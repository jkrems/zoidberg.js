module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c111 = function(name) { return new ZB.IdentifierExpression(getLocation(), name); },
        peg$c112 = ",",
        ...
        peg$c132 = function(first, accessPath) {
        ...
        peg$c149 = function(target, cases) {
        ...
        peg$c153 = function(name, dataType) {
            if (dataType) {
              dataType = dataType[1];
            } else {
              dataType = undefined;
            ...
            if (s3 !== peg$FAILED) {
              ...
              if (s6 !== peg$FAILED) {
                ...
                if (s7 !== peg$FAILED) {
                  s8 = peg$parse__();
                  if (s8 !== peg$FAILED) {
                    s9 = peg$parseListExpressionItem();
                    if (s9 !== peg$FAILED) {
                      s6 = [s6, s7, s8, s9];
                      s5 = s6;
                    } else {
    ...
    function peg$parseFCallExpression() {
      var s0, s1, s2, s3, s4;
    ...
    function peg$parseMemberAccessExpression() {
      var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;

      s0 = peg$currPos;
      s1 = peg$parseFCallExpression();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parse__();
    ...
    function peg$parseUnaryExpression() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse_();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseMemberAccessExpression();
          if (s3 !== peg$FAILED) {
            peg$reportedPos = s0;
            s1 = peg$c135(s1, s3);
            s0 = s1;
