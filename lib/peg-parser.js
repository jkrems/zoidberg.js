module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c135 = function(target, cases) {
            return new ZB.MatchExpression(getLocation(), target, cases);
          },
        peg$c136 = function(name, dataType) {
            if (dataType) {
              dataType = dataType[1];
            } else {
              dataType = undefined;
        ...
        peg$c140 = function(name, params, returnType, body) {
            if (params) {
