module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c97 = "type",
        peg$c98 = { type: "literal", value: "type", description: "\"type\"" },
        ...
        peg$c144 = function(target, cases) {
        ...
        peg$c148 = function(name, dataType) {
            if (dataType) {
              dataType = dataType[1];
            } else {
              dataType = undefined;
    ...
    function peg$parseTypeConstructors() {
      var s0, s1, s2, s3, s4, s5, s6, s7;
