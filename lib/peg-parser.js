module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c105 = function(name) { return new ZB.IdentifierExpression(getLocation(), name); },
        peg$c106 = ",",
        ...
        peg$c119 = function(expr) { return expr; },
        peg$c120 = /^[*\/%]/,
        ...
        peg$c129 = function(name, dataType) {
            if (dataType) {
              dataType = dataType[1];
            } else {
              dataType = undefined;
        ...
        peg$c133 = function(name, params, returnType, body) {
            if (params) {
