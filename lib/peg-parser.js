module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c130 = function(first, accessPath) {
        ...
        peg$c147 = function(target, cases) {
        ...
        peg$c151 = function(name, dataType) {
            if (dataType) {
              dataType = dataType[1];
            } else {
              dataType = undefined;
        ...
        peg$c158 = function(name, params, returnType, body) {
            if (params) {
